...
<div class="container">
    <h1 style="text-align: center"> Categories Crud</h1>
    <div align="right">
        <a class="btn btn-success " href="javascript:void(0)" id="createSubcategory"> Create New Category</a>
    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control" id="category_name" name="category_name"
                                   placeholder="Enter Category  Name" value="" maxlength="50" required="">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control" id="publication_status" name="publication_status"
                                   placeholder="Enter Publication Status" value="" maxlength="50" required="">
                        </div>
                    </div>
